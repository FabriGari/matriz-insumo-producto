...
function buildMult() {
  ...
  const explTextos = {
    C01: `El agro tiene un multiplicador de producción de 1.6866. Esto significa que ante un incremento de $1 en la demanda final agropecuaria, la producción total de la economía aumenta en $1.6866, capturando todos los efectos directos e indirectos sobre los 16 sectores. Sus principales insumos recibidos son de: manufactura ($3.068.451 miles), comercio ($561.343 miles) y transporte ($339.292 miles).`,
    C04: `La industria manufacturera registra el mayor multiplicador (1.9492). Por cada peso de demanda final industrial, se generan $1.9492 de producción en toda la economía. Sus principales insumos recibidos son: autoconsumo propio ($32.268.537 miles), agro ($13.661.176 miles), transporte ($6.197.991 miles) y comercio ($6.641.952 miles). Esta articulación con múltiples sectores explica su alto efecto multiplicador.`,
    C11: `Electricidad, gas y agua tiene un multiplicador de 1.7977. De los 5 sectores analizados, sus principales insumos recibidos son: autoconsumo propio ($2.025.245 miles), manufactura ($277.567 miles) y transporte ($697.957 miles). El alto autoconsumo refleja la naturaleza del sector energético, que consume su propia producción en el proceso de generación y distribución. El agro no le vende insumos directamente ($0).`,
    C13: `El comercio mayorista y minorista muestra el multiplicador más bajo (1.3892) de los 5 sectores, aunque no es mas bajo de los 16 sectores completos. Sus principales insumos recibidos son: Actividades inmobiliarias, empresariales y de alquiler ($4.537.716 miles),manufactura ($1.776.304 miles), transporte ($1.422.801 miles), electricidad ($456.578 miles) y autoconsumo propio ($235.371 miles). Notablemente, el agro no le vende insumos directamente ($0): los productos agropecuarios llegan al comercio ya procesados por la industria. Su VAB/VBP es el más alto de los 5 sectores (73.9%), lo que explica su menor multiplicador.`,
    C15: `Transporte y comunicaciones tiene un multiplicador de 1.5137. Sus principales insumos recibidos son: autoconsumo propio ($2.419.209 miles), manufactura ($3.005.326 miles), comercio ($317.249 miles) y electricidad ($264.858 miles). El agro prácticamente no le vende insumos directamente ($7 miles). Es un sector articulador clave de la cadena agro-exportadora porque presta servicios logísticos a todos los demás sectores.`,
  };
