...
function buildMult() {
  ...
  const explTextos = {
    ...
    C13: `Comercio mayorista y minorista muestra el <strong>multiplicador más bajo (${MULT.C13.valor.toFixed(3)})</strong>. Su valor agregado es altísimo (73.9% del VBP), lo que implica que requiere pocos insumos intermedios de los 5 sectores. No compra nada del agro directamente.`,
